...
For example, to build the Python wrapper (defaults to system Python):
 ...
 -DPYTHON_INCLUDE_DIR=$(python2 -c "import sysconfig; print(sysconfig.get_path('include'))")  \
 -DPYTHON_LIBRARY=$(python2 -c "import sysconfig; print(sysconfig.get_config_var('LIBDIR'))")
    make
...
cmake .. -DBUILD_PYTHON3=ON -DBUILD_EXAMPLES=OFF -DPYTHON_LIB_INSTALL_DIR=/usr/local/lib/python3.10/dist-packages
